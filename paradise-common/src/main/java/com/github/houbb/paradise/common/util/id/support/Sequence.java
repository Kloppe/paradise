...
package com.github.houbb.paradise.common.util.id.support;
...
public class Sequence {
    ...
    public Sequence(long workerId, long datacenterId) {
        if (workerId > maxWorkerId || workerId < 0) {
            throw new ParadiseCommonRuntimeException(String.format("worker Id can't be greater than %d or less than 0", maxWorkerId));
        }
        if (datacenterId > maxDatacenterId || datacenterId < 0) {
            throw new ParadiseCommonRuntimeException(
